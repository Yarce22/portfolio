...
interface PublishedDeploy {
  ...
  plugin_state: string;
  lighthouse_plugin_scores: Record<string, any> | null;
  links: DeployLinks;
...
export interface NetlifySite {
  ...
  dev_server_settings: Record<string, any>;
  ...
  primary_create_project: any | null;
  ...
  hud_enabled: boolean;
  labels: any[];
  traffic_rules_config_per_scope: Record<string, any>;
  visual_editor_active: boolean | null;
  description: string | null;
  description_hidden: boolean | null;
  dev_server_resources: any | null;
  created_via: string | null;
  deploy_origin: Record<string, any>;
