...
const Footer = () => {
  return(
    <footer id="contact" className="bg-Background">
      <div className="flex flex-col items-center px-6 py-32 bg-linear-to-l from-Titles to-green-950 rounded-t-[80px] opacity-80">
        <h2 className="pb-10 text-Text text-4xl font-Geist font-bold">CONTACT ME</h2>
